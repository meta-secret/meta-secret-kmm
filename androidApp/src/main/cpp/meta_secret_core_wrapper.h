#ifndef META_SECRET_CORE_SWIFT_WRAPPER_H
#define META_SECRET_CORE_SWIFT_WRAPPER_H

//#include <stdint.h>

extern char* generate_signed_user(const uint8_t *vault_name_bytes, size_t json_len);
