...
//                        .padding(.horizontal)
                    ...
                    // Buttons
                    NavigationLink(destination: WelcomeDBView(viewModel: OnboardingContnetViewModel(pageType: .third)), label: {
...
struct WelcomeAddPassword_Previews: PreviewProvider {
    static var previews: some View {
        WelcomeAddPassword(viewModel: OnboardingContnetViewModel(pageType: .first))
    }
}
